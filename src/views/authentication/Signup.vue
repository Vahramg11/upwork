        ...
        <div class="flex justify-center min-h-screen">
            ...
            <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                <div class="w-full">
                    ...
                    <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" @submit.prevent="onsubmit">
                        ...
                        <div>
                            <label class="text-left block mb-2 text-sm text-gray-600 dark:text-gray-200">First Name</label>
                        ...
                        <div>
                            <label class="text-left block mb-2 text-sm text-gray-600 dark:text-gray-200">Last name</label>
                        ...
                        <div>
                            <label class="text-left block mb-2 text-sm text-gray-600 dark:text-gray-200">Username
                            </label>
                        ...
                        <div>
                            <label class="text-left block mb-2 text-sm text-gray-600 dark:text-gray-200">Email
                                address</label>
                        ...
                        <div v-if="role == 'F'">
                            <label class="text-left block mb-2 text-sm text-gray-600 dark:text-gray-200">Profession</label>
                        ...
                        <div v-if="role == 'C'">
                            <label for="phone-input"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Phone
                                number:</label>
                        ...
                        <div>
                            <label class="text-left block mb-2 text-sm text-gray-600 dark:text-gray-200">Password</label>
                        ...
                        <div>
                            <label class="text-left block mb-2 text-sm text-gray-600 dark:text-gray-200">Confirm
                                password</label>
