<template>
    ...
    <a v-if="send" href="https://www.google.com/intl/en-US/gmail/about/">email send</a> -->
            ...
            <div class="p-4 sm:p-7">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <router-link to="/" class="text-blue-600 decoration-2 hover:underline font-medium" href="#">
                            Login here
                        </router-link>
                    </p>
                </div>
                ...
                <div class="mt-5 flex flex-col gap-5">
                    ...
                    <a v-if="send" href="https://mail.google.com/"
...
import { ref } from "vue"
const email = ref('vsaribekyan647@gmail.com')
const send = ref(false)

const requestPasswordReset = async () => {
    try {
        const { data } = await axios.post('http://127.0.0.1:8000/api/password_reset/', { email: email.value });
        console.log(data);
        if (data.status == "OK") {
            send.value = true
        }
