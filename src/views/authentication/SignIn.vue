        ...
        <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
                <div
                    ...
                    <form class="space-y-4" @submit.prevent="onsumbit">
                        <div class="mb-8">
                        ...
                        <div>
                            <label class="text-gray-800 text-sm mb-2 block text-left">username or email</label>
                        ...
                        <p class="text-sm !mt-8 text-center text-gray-800">Don't have an account <router-link
                                to="/sign_up"
